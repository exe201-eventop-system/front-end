...
const Auth = () => {
  ...
  const Testimonial = ({ type }: { type: "login" | "register" }) => {
    const backgroundImage =
      type === "login"
        ? "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8bztqYSgEZMkt6tXOe5BVlYUvyOGezhW12A&s')" 
        : "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDYac92KBnE8Q2AXVBJVOTPl8rZRBzsZPBTw&s')"; 
